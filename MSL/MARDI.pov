...
#declare TTT=frame_number*DT+Theatshield-6;
...
#declare CameraSky=QuatVectRotate(Q(TTT),-x);
#declare CameraLoc=QuatVectRotate(Q(TTT),z*(0.5+RappelDist));
#declare CameraLook=QuatVectRotate(Q(TTT),z*10);
