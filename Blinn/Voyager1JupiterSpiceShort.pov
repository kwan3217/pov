...
#declare Cal0="1979-03-05 00:00:00 UTC";
#declare Cal1="1979-03-07 00:00:00 UTC";
//#declare Cal0="1979-03-04 07:14:00 UTC";
//#declare Cal1="1979-03-04 07:14:01 UTC";
...
#declare ScanPlatformCK="Voyager/ck/vg1_jup_version1_type1_iss_sedr.bc";
#furnsh ScanPlatformCK
#declare NWnd=ckcov(ScanPlatformCK,-31100,"INTERVAL",0,"TDB",100000);
...
#include "Voyager.inc"
union {
  object{VoyagerQSpice(pxform("VG1_SCAN_PLATFORM","VG1_SC_BUS",ETScan)) finish {ambient 0.5}}
  PrintQuat("VG1_SC_BUS: ",pxform("VG1_SC_BUS",RefFrame,ET))
  QuatTrans(pxform("VG1_SC_BUS",RefFrame,ET),SCPos)
}
