...
#declare TRS=2000000*SystemScale;
#declare couleur=0.9;
#declare M_EC=1;
#declare MG=200*SystemScale;
#declare longitude=90;
#declare latitude=90-23.45;
#declare num_stars=4000;
...
#end
#declare Time=JulianDate(2004,Jul,1,00,00,00)+clock;
#warning "Here1"
CalcPlanetPos(Time)
...
camera {
  ...
  //direction 2
  look_at CameraPos*SystemScale+y
}
